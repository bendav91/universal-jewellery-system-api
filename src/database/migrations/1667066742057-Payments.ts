...
export class Payments1667066742057 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order_payments_payment" ("orderId" integer NOT NULL, "paymentId" integer NOT NULL, "paymentPaymentId" uuid NOT NULL, CONSTRAINT "PK_705bff9694efb0a2cf0d5925d21" PRIMARY KEY ("orderId", "paymentId", "paymentPaymentId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1a630be3ec93fc4a3e49508f00" ON "order_payments_payment" ("orderId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dff5ea3ef590f2a272a5bb667e" ON "order_payments_payment" ("paymentId", "paymentPaymentId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "order_payments_payment" ADD CONSTRAINT "FK_dff5ea3ef590f2a272a5bb667e2" FOREIGN KEY ("paymentId", "paymentPaymentId") REFERENCES "payment"("id","paymentId") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "order_payments_payment" DROP CONSTRAINT "FK_dff5ea3ef590f2a272a5bb667e2"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dff5ea3ef590f2a272a5bb667e"`,
    );
    await queryRunner.query(
