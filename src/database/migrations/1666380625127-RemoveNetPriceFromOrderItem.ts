...
export class RemoveNetPriceFromOrderItem1666380625127 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tax" ALTER COLUMN "rate" SET DEFAULT 0.2`);
        await queryRunner.query(`ALTER TABLE "order_item" ADD "netPrice" numeric(10,2) NOT NULL DEFAULT '0'`);
    }
