...
export class Payments1667059094812 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order" ADD CONSTRAINT "FK_e692a81b7a4debed6a92fbc11cb" FOREIGN KEY ("paymentsId", "paymentsPaymentId") REFERENCES "payment"("id","paymentId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "order" DROP CONSTRAINT "FK_e692a81b7a4debed6a92fbc11cb"`);
        await queryRunner.query(`ALTER TABLE "tax" ALTER COLUMN "rate" SET DEFAULT 0.2`);
        await queryRunner.query(`ALTER TABLE "order" DROP COLUMN "paymentsPaymentId"`);
